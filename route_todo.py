...
from databases import db_create_todo, db_get_single_todo, db_get_todos, db_update_todo, db_delete_todo
...
async def get_single_todo(request: Request, response: Response, id: str):
    ...
    if res:
        return res
    raise HTTPException(status_code = 404,detail="Task of ID:{id} dosen't exitst")
